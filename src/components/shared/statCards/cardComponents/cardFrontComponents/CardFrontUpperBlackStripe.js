...
const CardFrontUpperBlackStripe = () => {
  ...
  return SC.isSingleElement ? (
    <Grid
      ...
      sx={{ padding: "10px", color: "white", backgroundColor: "black" }}
    >
    ...
    <Grid item container direction="row" justifyContent="space-around" sx={{ padding: "10px", color: "white", backgroundColor: "black" }}>
